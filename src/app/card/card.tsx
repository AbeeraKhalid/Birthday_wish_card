    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center justify-between p-4 md:p-8 lg:p-12">
                ...
                {!click && <div>
                    <div className='bg-indigo-400  text-black p-4 md:p-6 lg:p-8 shadow-lg shadow-gray-700 rounded-xl w-full max-w-lg'>
                        {/* Form for user inputs */}
                        <form className='flex justify-center flex-col space-y-2' onSubmit={submitHandle}>
                            {/* Name input field */}
                            <div className="flex flex-col font-serif">
                                <label htmlFor="text" className="text-white text-center font-serif font-bold">Your Friend&apos;s Name</label>
                            ...
                            {/* Age input field */}
                            <div className="flex flex-col font-serif">
                                <label htmlFor="text" className="text-white text-center font-serif font-bold">Age</label>
                                {ageError && <p className="text-red-500 text-center text-sm">{ageError}</p>}
                                <input type="text" value={age} placeholder='Enter age of your friend...' onChange={(e) => setAge(e.target.value)}
                                    className="px-12 py-1 rounded-xl m-2 text-center" />
                            </div>

                            {/* Date of Birth input field */}
                            <div className="flex flex-col font-serif">
                                <label htmlFor="text" className="text-white text-center font-serif font-bold">Date of Birth</label>
                            ...
                            {/* Message input field */}
                            <div className="flex flex-col font-serif ">
                                <label htmlFor="text" className="text-white text-center font-serif font-bold">Your Message</label>
                            ...
                            <div className="flex flex-col font-serif ">
                                <label htmlFor="text" className="text-white text-center font-serif font-bold">Your Name</label>
                            ...
                            {/* Submit button */}
                            <button className="text-xl text-white font-bold bg-blue-800 font-serif rounded-xl px-0 py-4 hover:bg-blue-300">Generate Birthday Card</button>
                        </form>
                    </div>
                </div>}

                {/* Render birthday card if click is true */}
                {click && <div className="border-black p-4 rounded-xl border-2 bg-indigo-400">
                    <h1 className="text-2xl font-extrabold p-4 text-white text-center font-serif font-bold">Happy {ageInput}th Birthday!</h1>
                    <div className="bg-cyan-100 px-2 rounded-lg w-full max-w-lg text-center">
                    ...
                    <div className="flex flex-col justify-center items-center space-4 gap-1">
                        <div className="mt-8">
                            <h3 className="text-lg font-semibold text-black mb-2 ml-6 font-serif">Light the candles:</h3>
                        ...
                        {/* Balloons section */}
                        <div className="mt-8">
                            <h3 className="text-lg font-semibold text-black mb-2 ml-6 font-serif">Pop the balloons:</h3>
                            <div className="flex justify-center space-x-2">
                        ...
                        {/* Celebrate button */}
                        <button className=" font-serif bg-black text-white hover:bg-gray-800 transition-all duration-300 px-8 py-2 rounded-2xl flex flex-row" onClick={celebrateHandle} disabled={celebrating}>
                            <p>Celebrate!</p>
                            <FaGift className="ml-2 h-4 w-4" />
                        </button>
                        <p className="text-black text-lg font-semibold font-serif">From {senderInput}</p>
                    </div>
                </div>}
            </div>
        </div>
